...
[EOPortal](https://directory.eoportal.org/web/eoportal/satellite-missions/s/starlink)
"""
...
scene.center=false; save("starlink.png", scene, resolution=(save_resolution_scale*resolution[1], save_resolution_scale*resolution[2]));
