...
[Galileo GNSS](https://galileognss.eu/wp-content/uploads/2020/08/Galileo-OS-SDD_v1.1.pdf)
"""
...
scene.center=false; save("galileo.png", scene, resolution=(save_resolution_scale*resolution[1], save_resolution_scale*resolution[2]));
