...
[EOPortal](https://directory.eoportal.org/web/eoportal/satellite-missions/o/oneweb)
"""
...
scene.center=false; save("oneweb.png", scene, resolution=(save_resolution_scale*resolution[1], save_resolution_scale*resolution[2]));
