...
[GPS Performance standard](https://www.gps.gov/technical/ps/2020-SPS-performance-standard.pdf)
[USCG NAVCEN Constellation Status](https://www.navcen.uscg.gov/?Do=constellationStatus)
"""
...
scene.center=false; 
save("gps.png", scene, resolution=(save_resolution_scale*resolution[1], 
     save_resolution_scale*resolution[2]));
