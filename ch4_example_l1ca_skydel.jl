...
folder = "figures/l1ca_skydel/"

file = "/home/sjbilardi/Documents/SeNSeLab/GNSSTools.jl/test/data/skydel/20200301_000000_L1_1582.0_60.0.sc16"
data = loaddata(:sc16, file, 60e6, 1582e6, L1_freq, 2, skip_to=2)

replica = definereplica(define_l1ca_code_type(), 60e6, 2e-3)
detectable_prns = []
for i in 1:32
